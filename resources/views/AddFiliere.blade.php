...
<div class="row justify-content-center">
    ...
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-header">Add Filiere</div>

            <div class="card-body">



            <form action="{{ route('AddPostFiliere') }}" method="POST">
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        ...
        <input type="responsable" id="responsable" class="form-control" name="responsable" required>
